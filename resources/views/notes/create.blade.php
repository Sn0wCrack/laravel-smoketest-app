        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-3">
                <div class="mt-5 md:mt-0 md:col-span-3">
                    <form action="{{ route('notes.store') }}" method="POST" enctype="multipart/form-data" x-data="{ markdownPreview: false, body: '' }">
                        @csrf
                        ...
                        <div class="overflow-hidden shadow sm:rounded-md">
                            ...
                            <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                                ...
                                <a href="{{ route('notes.index') }}" class="ml-3 inline-flex justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
