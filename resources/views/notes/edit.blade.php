                            ...
                            <div class="bg-white px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" name="title" id="title" value="{{ old('title', $note->title) }}" required class="mt-1 block w-full rounded-md {{ $errors->has('title') ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-indigo-500 focus:ring-indigo-500' }} shadow-sm sm:text-sm">
                                        @error('title')
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <div x-show="!markdownPreview" class="mt-1">
                                            <textarea name="body" id="body" x-model="body" rows="12" required class="block w-full rounded-md {{ $errors->has('body') ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-indigo-500 focus:ring-indigo-500' }} shadow-sm sm:text-sm">{{ old('body', $note->body) }}</textarea>
                                            @error('body')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                        </div>
